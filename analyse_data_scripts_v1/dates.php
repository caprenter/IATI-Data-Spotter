...
$tests = array( "activity-date","transaction-date","budget/period-start","planned-disbursement/period-start");
$tests = array( "activity-date");

//Create a separate results file base on the data directory name
$save_directory = substr($dir,8,-1);
$data_file = $save_directory . "/" . substr($dir,8,-1) . "_dates.txt";
//echo $data_file; die;
             ...
             if ($xml = simplexml_load_file($dir . $file)) {
                ...
                foreach ($elements as $element) {
                  ...
                  //Special case: lang needs us to reference the XML namespace
                    ...
                    $date = $element->attributes()->{'iso-date'};
                    echo $date;
